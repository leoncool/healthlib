...
public class PostDatastreamTest {
	...
	public static void main(String args[]) {
		try {
			...
			// "domen_1", "float");
			// JsonDatastreamUnits unit4 = new JsonDatastreamUnits("elec", "uV",
			// "domen_2", "float");
			// JsonDatastreamUnits unit5 = new JsonDatastreamUnits("elec", "uV",
			// "domen_3", "float");
			// JsonDatastreamUnits unit6 = new JsonDatastreamUnits("other", "",
			// "tations", "float");
